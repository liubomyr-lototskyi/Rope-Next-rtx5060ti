...
def load_switch_icons():
    ...
    icon_off_img = Image.open(style.icon['IconOff']).resize((40, 40), Image.Resampling.LANCZOS)
    icon_on_img = Image.open(style.icon['IconOn']).resize((40, 40), Image.Resampling.LANCZOS)
